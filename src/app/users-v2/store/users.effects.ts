    ...
    return this.actions$.pipe(
      ...
      mergeMap(() => {
        return this.usersService.getUsers().pipe(
          map((users: any) =>
            UsersActions.GetUsersAPISuccess({
              list: users as IUser[],
              isLoading: false,
              error: '',
            })
          ...
          catchError((error: Error) =>
            of(
              UsersActions.GetUsersAPIFailure({
                list: [] as IUser[],
                isLoading: false,
                error: error.message,
              })
    ...
    return this.actions$.pipe(
      ...
      mergeMap((props) => {
        return this.usersService.getUserById(props.id).pipe(
          map((user: any) =>
            UsersActions.GetUserByIdAPISuccess({
              user: user as IUser,
              isLoading: false,
              error: '',
            })
          ...
          catchError((error: Error) =>
            of(
              UsersActions.GetUserByIdAPIFailure({
                user: {} as IUser,
                isLoading: false,
                error: error.message,
              })
    ...
    return this.actions$.pipe(
      ...
      mergeMap((props) => {
        return this.usersService.updateUserById(props.user).pipe(
          ...
          catchError((error: Error) =>
            of(
              UsersActions.UpdateUserByIdFailure({
                user: {} as IUser,
                isLoading: false,
                error: error.message,
              })
    ...
    return this.actions$.pipe(
      ...
      mergeMap((props) => {
        return this.usersService.addNewUser(props.user).pipe(
          map((user: any) =>
            UsersActions.AddNewUserSuccess({
              user: props.user as IUser,
              isLoading: false,
              error: '',
            })
          ...
          catchError((error) =>
            of(
              UsersActions.AddNewUserFailure({
                user: {} as IUser,
                isLoading: false,
                error: error.message,
              })
